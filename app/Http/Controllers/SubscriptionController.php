...
class SubscriptionController extends Controller
{
    ...
    public function createPaddleSession()
    {
        ...
        try {
            $checkoutUrl = $this->paymentService->setGateway('paddle')
    ...
    public function handleStarterPackage()
    {
        ...
        // Payment gateway can be either FastSpring or Paddle or PayProGlobal
        $paymentGateway = "Payment Plan from Admin" ?? config('payment.default_gateway');
    ...
    public function handleProPlan()
    {
        ...
        return view('subscription.pro', compact('hasStarterPackage', 'hasFreePackage', 'paymentGateway'));
    }
    ...
    public function handleBusinessPlan()
    {
        ...
        // Payment gateway can be either FastSpring or Paddle or PayProGlobal
        $paymentGateway = "Payment Plan from Admin" ?? config('payment.default_gateway');
        return view('subscription.business', compact('hasStarterPackage', 'hasFreePackage', 'paymentGateway'));
    }
