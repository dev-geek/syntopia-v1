    ...
    <div class="container">
      ...
      <div class="pricing-grid">
        ...
        <div class="card card-light">
          ...
          <button class="btn dark">{{ $hasFreePackage ? 'Activated' : 'Get Started' }}</button>
        ...
        <div class="card card-light">
          ...
          <button class="btn dark">{{ $hasStarterPackage ? 'Activated' : 'Get Started' }}</button>
          <p class="included-title">What's included</p>
          <ul class="features">
            <li><span class="icon"></span> 1 user</li>
            <li><span class="icon"></span> 1 livestream room</li>
        ...
        <div class="card card-dark">
          ...
          <button class="btn purple">{{ $hasProPackage ? 'Activated' : 'Get Started' }}</button>
          <p class="included-title">What's included</p>
          <ul class="features">
        ...
        <div class="card card-light">
          ...
          <button class="btn dark">{{ $hasBusinessPackage ? 'Activated' : 'Get Started' }}</button>
          <p class="included-title">What's included</p>
          <ul class="features">
